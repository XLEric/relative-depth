...
def parseArgs():
    ...
    parser.add_argument('-it', default=200000, type = int, help='Iterations')
    ...
    parser.add_argument('-t_depth_file', type =str,default='./DIW_train.csv', help = 'Training file for relative depth')
    parser.add_argument('-v_depth_file', type =str,default='./DIW_val.csv' , help = 'Validation file for relative depth')
    parser.add_argument('-rundir', default='../results' , help = 'Running directory')
    parser.add_argument('-ep', default=10 , type = int , help = 'Epochs')
    parser.add_argument('-start_from', default='Best_model_period4.pt' , help = 'Start from previous model')
    parser.add_argument('-diw', default=True , type = bool , help = 'Is training on DIW dataset')
...
if __name__ == "__main__":
    ...
    if g_args.start_from != '':
        ...
        print('pretrain model :',os.path.join(g_args.rundir , g_args.start_from))
    ...
    for i in range(0,g_args.it):
        ...
        # end = time.time()
        print((' {} - loss = {}'.format(i,running_loss)))
        lfile.write('loss = {}\n'.format(running_loss))
        ...
        if i % g_args.et == 0:
            ...
            print("train_eval_loss:",train_eval_loss.item(), "; train_eval_WKDR:" ,train_eval_WKDR)
            print("valid_eval_loss:", valid_eval_loss.item(), "; valid_eval_WKDR:", valid_eval_WKDR)
